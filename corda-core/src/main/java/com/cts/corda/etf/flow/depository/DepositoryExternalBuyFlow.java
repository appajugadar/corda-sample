...
@InitiatingFlow
@Slf4j
public class DepositoryExternalBuyFlow extends FlowLogic<SignedTransaction> {

    private Integer quantity;
    private String securityName;
    private String partyName;

    public DepositoryExternalBuyFlow(Integer quantity, String securityName, String partyName) {
        super();
    ...
    public SignedTransaction call() throws FlowException {
        ...
        SecurityBuyState securityBuyState = new SecurityBuyState(quantity, securityName, BUY_STARTED, buyer, getOurIdentity());
